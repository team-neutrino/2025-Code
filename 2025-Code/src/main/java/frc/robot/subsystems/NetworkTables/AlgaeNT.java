...
public class AlgaeNT extends Algae {
    NetworkTableInstance nt = NetworkTableInstance.getDefault();
    DoubleTopic encoderVelocity = nt.getDoubleTopic("/algae/encoder_velocity");
    DoubleTopic voltage = nt.getDoubleTopic("/algae/motor_input_voltage");
    BooleanTopic proxSensor = nt.getBooleanTopic("/algae/has_gamepiece");
    ...
    public void periodic() {
        ...
        proxSensorPub.set(debouncedHasAlgae(), now);
    }
}
