...
public class TunerConstants {
    ...
    public static final CANBus kCANBus = new CANBus("Creampuff", "./logs/example.hoot");

    // Theoretical free speed (m/s) at 12 V applied output;
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(3.94);

    // Every 1 rotation of the azimuth results in kCoupleRatio drive motor turns;
    // This may need to be tuned to your individual robot
    private static final double kCoupleRatio = 4.2;

    private static final double kDriveGearRatio = 8.100000000000001;
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.0234375);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.3310546875);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.27880859375);
