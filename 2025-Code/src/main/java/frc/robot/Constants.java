...
public final class Constants {
        ...
        public static class DriveToPoint {
                ...
                public static final Pose2d BLUE_CENTER_17 = DriveToPointCalculator
                                .CalculateAlgaePoint(layout.getTagPose(17).get());
                public static final Pose2d BLUE_CENTER_18 = DriveToPointCalculator
                                .CalculateAlgaePoint(layout.getTagPose(18).get());
                public static final Pose2d BLUE_CENTER_19 = DriveToPointCalculator
                                .CalculateAlgaePoint(layout.getTagPose(19).get());
                public static final Pose2d BLUE_CENTER_20 = DriveToPointCalculator
                                .CalculateAlgaePoint(layout.getTagPose(20).get());
                public static final Pose2d BLUE_CENTER_21 = DriveToPointCalculator
                                .CalculateAlgaePoint(layout.getTagPose(21).get());
                public static final Pose2d BLUE_CENTER_22 = DriveToPointCalculator
                                .CalculateAlgaePoint(layout.getTagPose(22).get());

                public static final Pose2d RED_CENTER_6 = DriveToPointCalculator
                                .CalculateAlgaePoint(layout.getTagPose(6).get());
                public static final Pose2d RED_CENTER_7 = DriveToPointCalculator
                                .CalculateAlgaePoint(layout.getTagPose(7).get());
                public static final Pose2d RED_CENTER_8 = DriveToPointCalculator
                                .CalculateAlgaePoint(layout.getTagPose(8).get());
                public static final Pose2d RED_CENTER_9 = DriveToPointCalculator
                                .CalculateAlgaePoint(layout.getTagPose(9).get());
                public static final Pose2d RED_CENTER_10 = DriveToPointCalculator
                                .CalculateAlgaePoint(layout.getTagPose(10).get());
                public static final Pose2d RED_CENTER_11 = DriveToPointCalculator
                ...
                public static final List<Pose2d> RED_REEF_CENTER = List.of(RED_CENTER_6, RED_CENTER_7, RED_CENTER_8,
                                RED_CENTER_9, RED_CENTER_10, RED_CENTER_11);

                public static final List<Pose2d> BLUE_REEF_CENTER = List.of(BLUE_CENTER_17, BLUE_CENTER_18,
                                BLUE_CENTER_19, BLUE_CENTER_20, BLUE_CENTER_21, BLUE_CENTER_22);
        }
